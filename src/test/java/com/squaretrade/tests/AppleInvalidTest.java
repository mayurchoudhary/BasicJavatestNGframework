...
public class AppleInvalidTest extends BaseTest{
	...
	public void baseAppleInvalidTest(String Username,String Password,String text) throws IOException, InterruptedException
	{
	...
	public Object[][] getData()
	{
		...
		//0th row
		data[0][0]="twettest1@gmail.com";
		data[0][1]="Intel@7373";
		data[0][2]="Appleinvalid User";
		//1st row
